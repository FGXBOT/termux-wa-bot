...
prefix = "!"
name = "~ FGX BOT"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN FGX BOT😁"
rmenu = "HAI TEMEN FGX BOT👋 JANGAN LUPA DONASI YAA:)"
botinfo = "UNTUK INVITE BOT SILAHKAN DONASI DULU YAA:)"
limitt = 10
memberLimit = 2
ban = []
premium = ["6285762102148@s.whatsapp.net"]
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["6285762102148@s.whatsapp.net"] // owner number ubah aja
